...
class layer_factory {
    public:
        ...
        virtual VkResult PostCallCreateRenderPass2KHR(VkDevice device, const VkRenderPassCreateInfo2KHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) { PostCallApiFunction("vkCreateRenderPass2KHR"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetPhysicalDeviceDisplayProperties2KHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayProperties2KHR* pProperties) { PostCallApiFunction("vkGetPhysicalDeviceDisplayProperties2KHR"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetPhysicalDeviceDisplayPlaneProperties2KHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlaneProperties2KHR* pProperties) { PostCallApiFunction("vkGetPhysicalDeviceDisplayPlaneProperties2KHR"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetDisplayModeProperties2KHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModeProperties2KHR* pProperties) { PostCallApiFunction("vkGetDisplayModeProperties2KHR"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetDisplayPlaneCapabilities2KHR(VkPhysicalDevice physicalDevice, const VkDisplayPlaneInfo2KHR* pDisplayPlaneInfo, VkDisplayPlaneCapabilities2KHR* pCapabilities) { PostCallApiFunction("vkGetDisplayPlaneCapabilities2KHR"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetImageDrmFormatModifierPropertiesEXT(VkDevice device, VkImage image, VkImageDrmFormatModifierPropertiesEXT* pProperties) { PostCallApiFunction("vkGetImageDrmFormatModifierPropertiesEXT"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallCreateAccelerationStructureNV(VkDevice device, const VkAccelerationStructureCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNV* pAccelerationStructure) { PostCallApiFunction("vkCreateAccelerationStructureNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallBindAccelerationStructureMemoryNV(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNV* pBindInfos) { PostCallApiFunction("vkBindAccelerationStructureMemoryNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallCreateRayTracingPipelinesNV(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoNV* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) { PostCallApiFunction("vkCreateRayTracingPipelinesNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetRayTracingShaderGroupHandlesNV(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) { PostCallApiFunction("vkGetRayTracingShaderGroupHandlesNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetAccelerationStructureHandleNV(VkDevice device, VkAccelerationStructureNV accelerationStructure, size_t dataSize, void* pData) { PostCallApiFunction("vkGetAccelerationStructureHandleNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallCompileDeferredNV(VkDevice device, VkPipeline pipeline, uint32_t shader) { PostCallApiFunction("vkCompileDeferredNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetPhysicalDeviceCalibrateableTimeDomainsEXT(VkPhysicalDevice physicalDevice, uint32_t* pTimeDomainCount, VkTimeDomainEXT* pTimeDomains) { PostCallApiFunction("vkGetPhysicalDeviceCalibrateableTimeDomainsEXT"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetCalibratedTimestampsEXT(VkDevice device, uint32_t timestampCount, const VkCalibratedTimestampInfoEXT* pTimestampInfos, uint64_t* pTimestamps, uint64_t* pMaxDeviation) { PostCallApiFunction("vkGetCalibratedTimestampsEXT"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallCreateImagePipeSurfaceFUCHSIA(VkInstance instance, const VkImagePipeSurfaceCreateInfoFUCHSIA* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) { PostCallApiFunction("vkCreateImagePipeSurfaceFUCHSIA"); return VK_SUCCESS; };
#endif
};
