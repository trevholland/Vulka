...
VKAPI_ATTR VkResult VKAPI_CALL EnumeratePhysicalDevices(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallEnumeratePhysicalDevices(instance, pPhysicalDeviceCount, pPhysicalDevices);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceImageFormatProperties(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceImageFormatProperties(physicalDevice, format, type, tiling, usage, flags, pImageFormatProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL QueueSubmit(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallQueueSubmit(queue, submitCount, pSubmits, fence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL QueueWaitIdle(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallQueueWaitIdle(queue);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL DeviceWaitIdle(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallDeviceWaitIdle(device);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AllocateMemory(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAllocateMemory(device, pAllocateInfo, pAllocator, pMemory);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL MapMemory(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallMapMemory(device, memory, offset, size, flags, ppData);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL FlushMappedMemoryRanges(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallFlushMappedMemoryRanges(device, memoryRangeCount, pMemoryRanges);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL InvalidateMappedMemoryRanges(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallInvalidateMappedMemoryRanges(device, memoryRangeCount, pMemoryRanges);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindBufferMemory(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindBufferMemory(device, buffer, memory, memoryOffset);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindImageMemory(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindImageMemory(device, image, memory, memoryOffset);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL QueueBindSparse(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallQueueBindSparse(queue, bindInfoCount, pBindInfo, fence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateFence(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateFence(device, pCreateInfo, pAllocator, pFence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ResetFences(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallResetFences(device, fenceCount, pFences);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetFenceStatus(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetFenceStatus(device, fence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL WaitForFences(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallWaitForFences(device, fenceCount, pFences, waitAll, timeout);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSemaphore(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSemaphore(device, pCreateInfo, pAllocator, pSemaphore);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateEvent(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateEvent(device, pCreateInfo, pAllocator, pEvent);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetEventStatus(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetEventStatus(device, event);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL SetEvent(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallSetEvent(device, event);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ResetEvent(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallResetEvent(device, event);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateQueryPool(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateQueryPool(device, pCreateInfo, pAllocator, pQueryPool);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetQueryPoolResults(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetQueryPoolResults(device, queryPool, firstQuery, queryCount, dataSize, pData, stride, flags);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateBuffer(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateBuffer(device, pCreateInfo, pAllocator, pBuffer);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateBufferView(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateBufferView(device, pCreateInfo, pAllocator, pView);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateImage(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateImage(device, pCreateInfo, pAllocator, pImage);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateImageView(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateImageView(device, pCreateInfo, pAllocator, pView);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateShaderModule(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateShaderModule(device, pCreateInfo, pAllocator, pShaderModule);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreatePipelineCache(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreatePipelineCache(device, pCreateInfo, pAllocator, pPipelineCache);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPipelineCacheData(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPipelineCacheData(device, pipelineCache, pDataSize, pData);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL MergePipelineCaches(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallMergePipelineCaches(device, dstCache, srcCacheCount, pSrcCaches);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateGraphicsPipelines(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateGraphicsPipelines(device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateComputePipelines(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateComputePipelines(device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreatePipelineLayout(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreatePipelineLayout(device, pCreateInfo, pAllocator, pPipelineLayout);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSampler(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSampler(device, pCreateInfo, pAllocator, pSampler);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDescriptorSetLayout(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDescriptorSetLayout(device, pCreateInfo, pAllocator, pSetLayout);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDescriptorPool(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDescriptorPool(device, pCreateInfo, pAllocator, pDescriptorPool);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ResetDescriptorPool(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallResetDescriptorPool(device, descriptorPool, flags);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AllocateDescriptorSets(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAllocateDescriptorSets(device, pAllocateInfo, pDescriptorSets);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL FreeDescriptorSets(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallFreeDescriptorSets(device, descriptorPool, descriptorSetCount, pDescriptorSets);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateFramebuffer(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateFramebuffer(device, pCreateInfo, pAllocator, pFramebuffer);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateRenderPass(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateRenderPass(device, pCreateInfo, pAllocator, pRenderPass);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateCommandPool(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateCommandPool(device, pCreateInfo, pAllocator, pCommandPool);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ResetCommandPool(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallResetCommandPool(device, commandPool, flags);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AllocateCommandBuffers(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAllocateCommandBuffers(device, pAllocateInfo, pCommandBuffers);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BeginCommandBuffer(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBeginCommandBuffer(commandBuffer, pBeginInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL EndCommandBuffer(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallEndCommandBuffer(commandBuffer);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ResetCommandBuffer(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallResetCommandBuffer(commandBuffer, flags);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindBufferMemory2(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindBufferMemory2(device, bindInfoCount, pBindInfos);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindImageMemory2(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindImageMemory2(device, bindInfoCount, pBindInfos);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL EnumeratePhysicalDeviceGroups(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallEnumeratePhysicalDeviceGroups(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceImageFormatProperties2(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceImageFormatProperties2(physicalDevice, pImageFormatInfo, pImageFormatProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSamplerYcbcrConversion(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSamplerYcbcrConversion(device, pCreateInfo, pAllocator, pYcbcrConversion);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDescriptorUpdateTemplate(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDescriptorUpdateTemplate(device, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceSupportKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceSupportKHR(physicalDevice, queueFamilyIndex, surface, pSupported);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceCapabilitiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice, surface, pSurfaceCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceFormatsKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice, surface, pSurfaceFormatCount, pSurfaceFormats);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfacePresentModesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice, surface, pPresentModeCount, pPresentModes);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSwapchainKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSwapchainKHR(device, pCreateInfo, pAllocator, pSwapchain);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetSwapchainImagesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetSwapchainImagesKHR(device, swapchain, pSwapchainImageCount, pSwapchainImages);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AcquireNextImageKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAcquireNextImageKHR(device, swapchain, timeout, semaphore, fence, pImageIndex);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL QueuePresentKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallQueuePresentKHR(queue, pPresentInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDeviceGroupPresentCapabilitiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDeviceGroupPresentCapabilitiesKHR(device, pDeviceGroupPresentCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDeviceGroupSurfacePresentModesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDeviceGroupSurfacePresentModesKHR(device, surface, pModes);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDevicePresentRectanglesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDevicePresentRectanglesKHR(physicalDevice, surface, pRectCount, pRects);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AcquireNextImage2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAcquireNextImage2KHR(device, pAcquireInfo, pImageIndex);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceDisplayPropertiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceDisplayPropertiesKHR(physicalDevice, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceDisplayPlanePropertiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneSupportedDisplaysKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDisplayPlaneSupportedDisplaysKHR(physicalDevice, planeIndex, pDisplayCount, pDisplays);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayModePropertiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDisplayModePropertiesKHR(physicalDevice, display, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDisplayModeKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDisplayModeKHR(physicalDevice, display, pCreateInfo, pAllocator, pMode);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneCapabilitiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDisplayPlaneCapabilitiesKHR(physicalDevice, mode, planeIndex, pCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDisplayPlaneSurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDisplayPlaneSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSharedSwapchainsKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSharedSwapchainsKHR(device, swapchainCount, pCreateInfos, pAllocator, pSwapchains);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateXlibSurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateXlibSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateXcbSurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateXcbSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateWaylandSurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateWaylandSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateAndroidSurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateAndroidSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateWin32SurfaceKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateWin32SurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceImageFormatProperties2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceImageFormatProperties2KHR(physicalDevice, pImageFormatInfo, pImageFormatProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL EnumeratePhysicalDeviceGroupsKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallEnumeratePhysicalDeviceGroupsKHR(instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryWin32HandleKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryWin32HandleKHR(device, pGetWin32HandleInfo, pHandle);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryWin32HandlePropertiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryWin32HandlePropertiesKHR(device, handleType, handle, pMemoryWin32HandleProperties);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_WIN32_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryFdKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryFdKHR(device, pGetFdInfo, pFd);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryFdPropertiesKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryFdPropertiesKHR(device, handleType, fd, pMemoryFdProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ImportSemaphoreWin32HandleKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallImportSemaphoreWin32HandleKHR(device, pImportSemaphoreWin32HandleInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetSemaphoreWin32HandleKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetSemaphoreWin32HandleKHR(device, pGetWin32HandleInfo, pHandle);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_WIN32_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL ImportSemaphoreFdKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallImportSemaphoreFdKHR(device, pImportSemaphoreFdInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetSemaphoreFdKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetSemaphoreFdKHR(device, pGetFdInfo, pFd);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDescriptorUpdateTemplateKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDescriptorUpdateTemplateKHR(device, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateRenderPass2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateRenderPass2KHR(device, pCreateInfo, pAllocator, pRenderPass);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetSwapchainStatusKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetSwapchainStatusKHR(device, swapchain);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ImportFenceWin32HandleKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallImportFenceWin32HandleKHR(device, pImportFenceWin32HandleInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetFenceWin32HandleKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetFenceWin32HandleKHR(device, pGetWin32HandleInfo, pHandle);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_WIN32_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL ImportFenceFdKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallImportFenceFdKHR(device, pImportFenceFdInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetFenceFdKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetFenceFdKHR(device, pGetFdInfo, pFd);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceCapabilities2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceCapabilities2KHR(physicalDevice, pSurfaceInfo, pSurfaceCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceFormats2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceFormats2KHR(physicalDevice, pSurfaceInfo, pSurfaceFormatCount, pSurfaceFormats);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceDisplayProperties2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceDisplayProperties2KHR(physicalDevice, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceDisplayPlaneProperties2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceDisplayPlaneProperties2KHR(physicalDevice, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayModeProperties2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDisplayModeProperties2KHR(physicalDevice, display, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDisplayPlaneCapabilities2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDisplayPlaneCapabilities2KHR(physicalDevice, pDisplayPlaneInfo, pCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateSamplerYcbcrConversionKHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateSamplerYcbcrConversionKHR(device, pCreateInfo, pAllocator, pYcbcrConversion);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindBufferMemory2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindBufferMemory2KHR(device, bindInfoCount, pBindInfos);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindImageMemory2KHR(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindImageMemory2KHR(device, bindInfoCount, pBindInfos);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL DebugMarkerSetObjectTagEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallDebugMarkerSetObjectTagEXT(device, pTagInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL DebugMarkerSetObjectNameEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallDebugMarkerSetObjectNameEXT(device, pNameInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetShaderInfoAMD(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetShaderInfoAMD(device, pipeline, shaderStage, infoType, pInfoSize, pInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceExternalImageFormatPropertiesNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceExternalImageFormatPropertiesNV(physicalDevice, format, type, tiling, usage, flags, externalHandleType, pExternalImageFormatProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryWin32HandleNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryWin32HandleNV(device, memory, handleType, pHandle);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_WIN32_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL CreateViSurfaceNN(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateViSurfaceNN(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateIndirectCommandsLayoutNVX(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateIndirectCommandsLayoutNVX(device, pCreateInfo, pAllocator, pIndirectCommandsLayout);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateObjectTableNVX(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateObjectTableNVX(device, pCreateInfo, pAllocator, pObjectTable);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL RegisterObjectsNVX(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallRegisterObjectsNVX(device, objectTable, objectCount, ppObjectTableEntries, pObjectIndices);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL UnregisterObjectsNVX(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallUnregisterObjectsNVX(device, objectTable, objectCount, pObjectEntryTypes, pObjectIndices);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ReleaseDisplayEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallReleaseDisplayEXT(physicalDevice, display);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AcquireXlibDisplayEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAcquireXlibDisplayEXT(physicalDevice, dpy, display);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetRandROutputDisplayEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetRandROutputDisplayEXT(physicalDevice, dpy, rrOutput, pDisplay);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfaceCapabilities2EXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfaceCapabilities2EXT(physicalDevice, surface, pSurfaceCapabilities);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL DisplayPowerControlEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallDisplayPowerControlEXT(device, display, pDisplayPowerInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL RegisterDeviceEventEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallRegisterDeviceEventEXT(device, pDeviceEventInfo, pAllocator, pFence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL RegisterDisplayEventEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallRegisterDisplayEventEXT(device, display, pDisplayEventInfo, pAllocator, pFence);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetSwapchainCounterEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetSwapchainCounterEXT(device, swapchain, counter, pCounterValue);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetRefreshCycleDurationGOOGLE(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetRefreshCycleDurationGOOGLE(device, swapchain, pDisplayTimingProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPastPresentationTimingGOOGLE(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPastPresentationTimingGOOGLE(device, swapchain, pPresentationTimingCount, pPresentationTimings);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateIOSSurfaceMVK(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateIOSSurfaceMVK(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateMacOSSurfaceMVK(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateMacOSSurfaceMVK(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL SetDebugUtilsObjectNameEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallSetDebugUtilsObjectNameEXT(device, pNameInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL SetDebugUtilsObjectTagEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallSetDebugUtilsObjectTagEXT(device, pTagInfo);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateDebugUtilsMessengerEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateDebugUtilsMessengerEXT(instance, pCreateInfo, pAllocator, pMessenger);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetAndroidHardwareBufferPropertiesANDROID(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetAndroidHardwareBufferPropertiesANDROID(device, buffer, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryAndroidHardwareBufferANDROID(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryAndroidHardwareBufferANDROID(device, pInfo, pBuffer);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_ANDROID_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL GetImageDrmFormatModifierPropertiesEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetImageDrmFormatModifierPropertiesEXT(device, image, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateValidationCacheEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateValidationCacheEXT(device, pCreateInfo, pAllocator, pValidationCache);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL MergeValidationCachesEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallMergeValidationCachesEXT(device, dstCache, srcCacheCount, pSrcCaches);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetValidationCacheDataEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetValidationCacheDataEXT(device, validationCache, pDataSize, pData);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateAccelerationStructureNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateAccelerationStructureNV(device, pCreateInfo, pAllocator, pAccelerationStructure);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL BindAccelerationStructureMemoryNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallBindAccelerationStructureMemoryNV(device, bindInfoCount, pBindInfos);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateRayTracingPipelinesNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateRayTracingPipelinesNV(device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetRayTracingShaderGroupHandlesNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetRayTracingShaderGroupHandlesNV(device, pipeline, firstGroup, groupCount, dataSize, pData);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetAccelerationStructureHandleNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetAccelerationStructureHandleNV(device, accelerationStructure, dataSize, pData);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CompileDeferredNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCompileDeferredNV(device, pipeline, shader);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetMemoryHostPointerPropertiesEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetMemoryHostPointerPropertiesEXT(device, handleType, pHostPointer, pMemoryHostPointerProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceCalibrateableTimeDomainsEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceCalibrateableTimeDomainsEXT(physicalDevice, pTimeDomainCount, pTimeDomains);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetCalibratedTimestampsEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetCalibratedTimestampsEXT(device, timestampCount, pTimestampInfos, pTimestamps, pMaxDeviation);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateImagePipeSurfaceFUCHSIA(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateImagePipeSurfaceFUCHSIA(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
