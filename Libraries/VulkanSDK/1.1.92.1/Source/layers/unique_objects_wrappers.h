    ...
    VkImageFormatProperties2*                   pImageFormatProperties)
{
    ...
    safe_VkPhysicalDeviceImageFormatInfo2 *local_pImageFormatInfo = NULL;
    {
        ...
        if (pImageFormatInfo) {
            ...
            local_pImageFormatInfo->pNext = CreateUnwrappedExtensionStructs(local_pImageFormatInfo->pNext);
        }
    }
    VkResult result = dev_data->dispatch_table.GetPhysicalDeviceImageFormatProperties2(physicalDevice, (const VkPhysicalDeviceImageFormatInfo2*)local_pImageFormatInfo, pImageFormatProperties);
    ...
    VkImageFormatProperties2*                   pImageFormatProperties)
{
    ...
    VkResult result = dev_data->dispatch_table.GetPhysicalDeviceImageFormatProperties2KHR(physicalDevice, (const VkPhysicalDeviceImageFormatInfo2*)local_pImageFormatInfo, pImageFormatProperties);
    if (local_pImageFormatInfo) {
        FreeUnwrappedExtensionStructs(const_cast<void *>(local_pImageFormatInfo->pNext));
        delete local_pImageFormatInfo;
    }
    ...
    const VkDeviceSize*                         pSizes)
{
    ...
    dev_data->dispatch_table.CmdBindTransformFeedbackBuffersEXT(commandBuffer, firstBinding, bindingCount, (const VkBuffer*)local_pBuffers, pOffsets, pSizes);
    if (local_pBuffers)
        delete[] local_pBuffers;
}
    ...
    const VkDeviceSize*                         pCounterBufferOffsets)
{
    ...
    dev_data->dispatch_table.CmdBeginTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBufferCount, (const VkBuffer*)local_pCounterBuffers, pCounterBufferOffsets);
    ...
    const VkDeviceSize*                         pCounterBufferOffsets)
{
    ...
    dev_data->dispatch_table.CmdEndTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBufferCount, (const VkBuffer*)local_pCounterBuffers, pCounterBufferOffsets);
    if (local_pCounterBuffers)
        delete[] local_pCounterBuffers;
}
    ...
    uint32_t                                    index)
{
    ...
    dev_data->dispatch_table.CmdBeginQueryIndexedEXT(commandBuffer, queryPool, query, flags, index);
    ...
    uint32_t                                    index)
{
    ...
    dev_data->dispatch_table.CmdEndQueryIndexedEXT(commandBuffer, queryPool, query, index);
    ...
    uint32_t                                    vertexStride)
{
    ...
    dev_data->dispatch_table.CmdDrawIndirectByteCountEXT(commandBuffer, instanceCount, firstInstance, counterBuffer, counterBufferOffset, counterOffset, vertexStride);
    ...
    VkImageDrmFormatModifierPropertiesEXT*      pProperties)
{
    ...
    VkResult result = dev_data->dispatch_table.GetImageDrmFormatModifierPropertiesEXT(device, image, pProperties);
            ...
            if (local_pCreateInfo->info.pGeometries) {
                for (uint32_t index2 = 0; index2 < local_pCreateInfo->info.geometryCount; ++index2) {
                    if (pCreateInfo->info.pGeometries[index2].geometry.triangles.vertexData) {
                        local_pCreateInfo->info.pGeometries[index2].geometry.triangles.vertexData = Unwrap(pCreateInfo->info.pGeometries[index2].geometry.triangles.vertexData);
                    }
                    if (pCreateInfo->info.pGeometries[index2].geometry.triangles.indexData) {
                        local_pCreateInfo->info.pGeometries[index2].geometry.triangles.indexData = Unwrap(pCreateInfo->info.pGeometries[index2].geometry.triangles.indexData);
                    }
                    if (pCreateInfo->info.pGeometries[index2].geometry.triangles.transformData) {
                        local_pCreateInfo->info.pGeometries[index2].geometry.triangles.transformData = Unwrap(pCreateInfo->info.pGeometries[index2].geometry.triangles.transformData);
                    }
                    if (pCreateInfo->info.pGeometries[index2].geometry.aabbs.aabbData) {
                        local_pCreateInfo->info.pGeometries[index2].geometry.aabbs.aabbData = Unwrap(pCreateInfo->info.pGeometries[index2].geometry.aabbs.aabbData);
                    }
                }
            }
        }
    }
    VkResult result = dev_data->dispatch_table.CreateAccelerationStructureNV(device, (const VkAccelerationStructureCreateInfoNV*)local_pCreateInfo, pAllocator, pAccelerationStructure);
    if (local_pCreateInfo) {
        delete local_pCreateInfo;
    }
    if (VK_SUCCESS == result) {
    ...
    const VkAllocationCallbacks*                pAllocator)
{
    ...
    lock.unlock();
    dev_data->dispatch_table.DestroyAccelerationStructureNV(device, accelerationStructure, pAllocator);
    ...
    VkMemoryRequirements2KHR*                   pMemoryRequirements)
{
    ...
    dev_data->dispatch_table.GetAccelerationStructureMemoryRequirementsNV(device, (const VkAccelerationStructureMemoryRequirementsInfoNV*)local_pInfo, pMemoryRequirements);
    if (local_pInfo) {
        delete local_pInfo;
    }
}
    ...
    const VkBindAccelerationStructureMemoryInfoNV* pBindInfos)
{
    ...
    VkResult result = dev_data->dispatch_table.BindAccelerationStructureMemoryNV(device, bindInfoCount, (const VkBindAccelerationStructureMemoryInfoNV*)local_pBindInfos);
    if (local_pBindInfos) {
        delete[] local_pBindInfos;
    }
    return result;
    ...
    VkDeviceSize                                scratchOffset)
{
            ...
            if (local_pInfo->pGeometries) {
                for (uint32_t index1 = 0; index1 < local_pInfo->geometryCount; ++index1) {
                    if (pInfo->pGeometries[index1].geometry.triangles.vertexData) {
                        local_pInfo->pGeometries[index1].geometry.triangles.vertexData = Unwrap(pInfo->pGeometries[index1].geometry.triangles.vertexData);
                    }
                    if (pInfo->pGeometries[index1].geometry.triangles.indexData) {
                        local_pInfo->pGeometries[index1].geometry.triangles.indexData = Unwrap(pInfo->pGeometries[index1].geometry.triangles.indexData);
                    }
                    if (pInfo->pGeometries[index1].geometry.triangles.transformData) {
                        local_pInfo->pGeometries[index1].geometry.triangles.transformData = Unwrap(pInfo->pGeometries[index1].geometry.triangles.transformData);
                    }
                    if (pInfo->pGeometries[index1].geometry.aabbs.aabbData) {
                        local_pInfo->pGeometries[index1].geometry.aabbs.aabbData = Unwrap(pInfo->pGeometries[index1].geometry.aabbs.aabbData);
                    }
                }
            }
        }
    ...
    dev_data->dispatch_table.CmdBuildAccelerationStructureNV(commandBuffer, (const VkAccelerationStructureInfoNV*)local_pInfo, instanceData, instanceOffset, update, dst, src, scratch, scratchOffset);
    if (local_pInfo) {
        delete local_pInfo;
    }
}
    ...
    VkCopyAccelerationStructureModeNV           mode)
{
    ...
    dev_data->dispatch_table.CmdCopyAccelerationStructureNV(commandBuffer, dst, src, mode);
    ...
    uint32_t                                    depth)
{
    ...
    dev_data->dispatch_table.CmdTraceRaysNV(commandBuffer, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, callableShaderBindingTableBuffer, callableShaderBindingOffset, callableShaderBindingStride, width, height, depth);
    ...
    VkPipeline*                                 pPipelines)
{
    ...
    VkResult result = dev_data->dispatch_table.CreateRayTracingPipelinesNV(device, pipelineCache, createInfoCount, (const VkRayTracingPipelineCreateInfoNV*)local_pCreateInfos, pAllocator, pPipelines);
    ...
    void*                                       pData)
{
    ...
    VkResult result = dev_data->dispatch_table.GetRayTracingShaderGroupHandlesNV(device, pipeline, firstGroup, groupCount, dataSize, pData);
    ...
    void*                                       pData)
{
    ...
    VkResult result = dev_data->dispatch_table.GetAccelerationStructureHandleNV(device, accelerationStructure, dataSize, pData);
    ...
    uint32_t                                    firstQuery)
{
    ...
    dev_data->dispatch_table.CmdWriteAccelerationStructuresPropertiesNV(commandBuffer, accelerationStructureCount, (const VkAccelerationStructureNV*)local_pAccelerationStructures, queryType, queryPool, firstQuery);
    ...
    uint32_t                                    shader)
{
    ...
    VkResult result = dev_data->dispatch_table.CompileDeferredNV(device, pipeline, shader);
